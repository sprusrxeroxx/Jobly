...
import 'profile_user_modal_model.dart';
export 'profile_user_modal_model.dart';

class ProfileUserModalWidget extends StatefulWidget {
  const ProfileUserModalWidget({super.key});

  @override
  State<ProfileUserModalWidget> createState() => _ProfileUserModalWidgetState();
}

class _ProfileUserModalWidgetState extends State<ProfileUserModalWidget>
    with TickerProviderStateMixin {
  late ProfileUserModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileUserModalModel());
